...
class __TwigTemplate_1878a19bbb0546da674347e6b0125d2df173e5c4547246df1f7a1def007ca646 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 20
        $context["groupId"] = $this->getAttribute($this->getAttribute((isset($context["craft"]) ? $context["craft"] : null), "request"), "getQuery", array(0 => "groupId"), "method");
        // line 22
        if ((!(isset($context["groupId"]) ? $context["groupId"] : null))) {
            // line 23
            if (array_key_exists("field", $context)) {
                // line 24
                $context["groupId"] = $this->getAttribute((isset($context["field"]) ? $context["field"] : null), "groupId");
            } else {
                // line 26
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 72
            echo "\t\t\t";
            $context["groupOptions"] = twig_array_merge((isset($context["groupOptions"]) ? $context["groupOptions"] : null), array(0 => array("label" => $this->getAttribute((isset($context["group"]) ? $context["group"] : null), "name"), "value" => $this->getAttribute((isset($context["group"]) ? $context["group"] : null), "id"))));
            // line 73
            echo "\t\t";
        }
...
\t\t";
        // line 84
        echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("Name"), "instructions" => \Craft\Craft::t("What this field will be called in the CP."), "id" => "name", "name" => "name", "value" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "name")) : (null)), "errors" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "getErrors", array(0 => "name"), "method")) : (null)), "required" => true, "translatable" => true, "autofocus" => true));
        // line 94
        echo "

\t\t";
        // line 96
        echo $context["forms"]->gettextField(array("label" => \Craft\Craft::t("Handle"), "instructions" => \Craft\Craft::t("How you’ll refer to this field in the templates."), "id" => "handle", "class" => "code", "name" => "handle", "maxlength" => 64, "value" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "handle")) : (null)), "errors" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "getErrors", array(0 => "handle"), "method")) : (null)), "required" => true));
        // line 106
        echo "

\t\t";
        // line 108
        echo $context["forms"]->gettextareaField(array("label" => \Craft\Craft::t("Instructions"), "instructions" => \Craft\Craft::t("Helper text to guide the author."), "id" => "instructions", "class" => "nicetext", "name" => "instructions", "value" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "instructions")) : (null)), "errors" => ((array_key_exists("field", $context)) ? ($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "getErrors", array(0 => "instructions"), "method")) : (null)), "translatable" => true));
        // line 117
        echo "
...
\t\t";
        // line 129
        echo $context["forms"]->getselectField(array("label" => \Craft\Craft::t("Field Type"), "instructions" => (\Craft\Craft::t("What type of field is this?") . ((array_key_exists("fieldId", $context)) ? ((("<br><span class=\"error\">" . \Craft\Craft::t("Careful—changing this may result in data loss.")) . "</span>")) : (""))), "id" => "type", "name" => "type", "options" => (isset($context["fieldTypes"]) ? $context["fieldTypes"] : null), "value" => $this->getAttribute((isset($context["fieldType"]) ? $context["fieldType"] : null), "getClassHandle", array(), "method"), "errors" => (((isset($context["isFieldTypeMissing"]) ? $context["isFieldTypeMissing"] : null)) ? (array(0 => \Craft\Craft::t("The fieldtype class “{class}” could not be found.", array("class" => $this->getAttribute((isset($context["field"]) ? $context["field"] : null), "type"))))) : (null)), "toggle" => true));
        // line 138
        echo "
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["_fieldType"]) {
            // line 141
            echo "\t\t\t";
            $context["isCurrent"] = ($this->getAttribute((isset($context["_fieldType"]) ? $context["_fieldType"] : null), "getClassHandle", array(), "method") == $this->getAttribute((isset($context["fieldType"]) ? $context["fieldType"] : null), "getClassHandle", array(), "method"));
            // line 142
            echo "\t\t\t<div id=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["_fieldType"]) ? $context["_fieldType"] : null), "getClassHandle", array(), "method"), "html", null, true);
            echo "\"";
...
\t\t\t\t";
            // line 143
            $_namespace = (("types[" . $this->getAttribute((isset($context["_fieldType"]) ? $context["_fieldType"] : null), "getClassHandle", array(), "method")) . "]");
            if ($_namespace) {
...
\t\t\t\t\t";
                        ...
                        // line 147
                        echo "\t\t\t\t\t\t";
                        echo $this->getAttribute((isset($context["_fieldType"]) ? $context["_fieldType"] : null), "getSettingsHtml", array(), "method");
                        echo "
\t\t\t\t\t";
                    }
                    // line 149
...
";
        ...
        // line 162
        if (((!array_key_exists("field", $context)) || (!$this->getAttribute((isset($context["field"]) ? $context["field"] : null), "handle")))) {
            // line 163
