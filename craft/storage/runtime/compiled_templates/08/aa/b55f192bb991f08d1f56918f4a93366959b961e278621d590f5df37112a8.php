...
class __TwigTemplate_08aab55f192bb991f08d1f56918f4a93366959b961e278621d590f5df37112a8 extends Twig_Template
{
...
\t\t\t\t\t<td data-title=\"";
            ...
            echo twig_escape_filter($this->env, \Craft\Craft::t("Handle"), "html", null, true);
            echo "\"><code>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entryType"]) ? $context["entryType"] : null), "handle"), "html", null, true);
            echo "</code></td>
\t\t\t\t\t";
            // line 21
            if ((isset($context["multiple"]) ? $context["multiple"] : null)) {
...
\t\t\t<a href=\"";
            // line 32
            echo twig_escape_filter($this->env, \Craft\UrlHelper::getUrl((("settings/sections/" . $this->getAttribute((isset($context["section"]) ? $context["section"] : null), "id")) . "/entrytypes/new")), "html", null, true);
